...
const SvgZoomOut = (props) => (
    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 330 330" style={{
            enableBackground: "new 0 0 330 330",
        }}
        xmlSpace="preserve" {...props}>
        <g id="XMLID_30_">
            <path id="XMLID_31_" d="M325.606,304.394L223.329,202.116c16.706-21.256,26.682-48.04,26.682-77.111
		...
		c52.387,0,95.006,42.619,95.006,95.005c0,52.386-42.619,95.005-95.006,95.005C72.619,220.01,30,177.391,30,125.006z"/>
            <path id="XMLID_86_" d="M155.005,110.006h-60c-8.284,0-15,6.716-15,15s6.716,15,15,15h60c8.284,0,15-6.716,15-15
